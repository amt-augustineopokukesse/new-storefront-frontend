...
import { setProjectReviews } from "../../../Redux/Templates/ProjectSlice";
...
export const ReviewForm: React.FC<modalProp> = ({ openFormModal, setOpenFormModal }) => {
    ...
    const handlePost = async () => {
        const sendReview = await api.post(`/api/customer/review`, {
            project_id:id,
            rating: receivedData,
            comment: review
            }
